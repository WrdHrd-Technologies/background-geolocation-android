...
public final class SQLiteConfigurationContract {
    ...
    public static abstract class ConfigurationEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME_GEOFENCE_URL = "geofence_url";
        public static final String COLUMN_NAME_SYNC_GEOFENCE_URL = "sync_geofence_url";
        ...
        public static final String SQL_CREATE_CONFIG_TABLE =
                "CREATE TABLE " + ConfigurationEntry.TABLE_NAME + " (" +
                        ...
                        ConfigurationEntry.COLUMN_NAME_GEOFENCE + INTEGER_TYPE +
                        ConfigurationEntry.COLUMN_NAME_GEOFENCE_URL + TEXT_TYPE +
                        ConfigurationEntry.COLUMN_NAME_SYNC_GEOFENCE_URL + TEXT_TYPE +
                        " )";
